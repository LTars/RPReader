...
```
css/
  common.css              — variables, reset, layout (panel, main), shared components
...
content/
  ...
  character-appearances.json — generated by process.js

data/
  parser-rules.json       — parsing rules (authors)
  characters/
    index.json            — character registry
    {id}.json             — character details

raw/                      — source material and reference (not part of pipeline)

scripts/
  process.js              — text processing pipeline (main.md → blocks/)
  test.js                 — unit tests
